...
class Form extends Component
{
    ...
    public function guardar()
    {
        ...
        try {
            ...
            // Verificar que el ID del empleado esté disponible antes de sincronizar beneficiarios
            if (!$this->empleado_id) {
                throw new \Exception('No se pudo obtener el ID del empleado después de guardarlo.');
            }
