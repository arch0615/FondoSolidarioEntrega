            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-secondary-200">
                    ...
                    <tbody class="bg-white divide-y divide-secondary-200">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $emails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emailItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-secondary-50 transition-colors duration-150 <?php echo e(!$emailItem->activo ? 'opacity-50' : ''); ?>">
                            <!--[if BLOCK]><![endif]--><?php if($editingId === $emailItem->id_email_aseguradora): ?>
                                <!-- Modo edición -->
                                <td class="px-6 py-4">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($emailItem->activo ? 'bg-success-100 text-success-800' : 'bg-secondary-100 text-secondary-800'); ?>">
                                        <?php echo e($emailItem->activo ? 'Activo' : 'Inactivo'); ?>
                            ...
                            <?php else: ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm font-medium text-secondary-900"><?php echo e($emailItem->email); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-secondary-600"><?php echo e($emailItem->descripcion ?? '-'); ?></span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <button wire:click="toggleActivo(<?php echo e($emailItem->id_email_aseguradora); ?>)" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium cursor-pointer transition-colors <?php echo e($emailItem->activo ? 'bg-success-100 text-success-800 hover:bg-success-200' : 'bg-secondary-100 text-secondary-800 hover:bg-secondary-200'); ?>">
                                        <?php echo e($emailItem->activo ? 'Activo' : 'Inactivo'); ?>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        <button wire:click="editar(<?php echo e($emailItem->id_email_aseguradora); ?>)" class="p-2 text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-full transition-colors" title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button wire:click="confirmarEliminar(<?php echo e($emailItem->id_email_aseguradora); ?>)" class="p-2 text-danger-600 hover:text-danger-800 hover:bg-danger-50 rounded-full transition-colors" title="Eliminar">
...
<?php /**PATH /home/ubuntu/Documents/FondoSolidarioEntrega/FondoSolidarioEntrega/resources/views/livewire/emails-aseguradora/index.blade.php ENDPATH**/ ?>