<div wire:key="historial-auditorias-<?php echo e(now()); ?>">
    ...
    <div class="mb-12">
        ...
        <div class="bg-white rounded-xl border border-secondary-200 overflow-hidden">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-secondary-200">
                    ...
                    <tbody class="bg-white divide-y divide-secondary-200">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $solicitudes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $solicitud): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <tr class="hover:bg-secondary-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap"><div class="text-sm font-medium text-secondary-900"><?php echo e($solicitud->fecha_solicitud->format('d/m/Y H:i:s')); ?></div></td>
                                <td class="px-6 py-4 whitespace-nowrap"><div class="text-sm text-secondary-900"><?php echo e($solicitud->reintegro->accidente->alumnos->first()->alumno->nombre_completo ?? 'N/A'); ?></div></td>
                                <td class="px-6 py-4 whitespace-nowrap"><div class="text-sm text-secondary-900"><?php echo e($solicitud->reintegro->accidente->escuela->nombre ?? 'N/A'); ?></div></td>
                                <td class="px-6 py-4 whitespace-nowrap text-center"><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-<?php echo e($color); ?>-100 text-<?php echo e($color); ?>-800"><?php echo e($evento); ?></span></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-secondary-500"><?php echo e($solicitud->auditor->email ?? 'N/A'); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <a href="<?php echo e(route('auditoria.detalle', ['type' => 'solicitud', 'id' => $solicitud->id_solicitud])); ?>" class="p-2 text-secondary-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors duration-200" title="Ver detalles">
            ...
            <div class="px-6 py-4 bg-secondary-50 border-t border-secondary-200"><?php echo e($solicitudes->links()); ?></div>
        </div>
    </div>
