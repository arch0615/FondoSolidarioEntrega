            ...
            <div class="mb-4">
                ...
                <div class="grid grid-cols-2 gap-4 mt-2">
                    <?php $__currentLoopData = $archivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $archivo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(in_array(strtolower(pathinfo($archivo->nombre_archivo, PATHINFO_EXTENSION)), ['jpg', 'jpeg', 'png', 'gif', 'webp', 'bmp'])): ?>
                            <div class="border border-gray-200 rounded-md p-2 text-center">
                                <img src="<?php echo e(asset('storage/' . $archivo->ruta_archivo)); ?>"
                                     alt="<?php echo e($archivo->nombre_archivo); ?>"
                                     class="w-full h-auto max-h-64 object-contain rounded">
                                <p class="text-xs text-gray-500 mt-1"><?php echo e($archivo->nombre_archivo); ?></p>
                            </div>
                        <?php else: ?>
                            <div class="border border-gray-200 rounded-md p-2 flex items-center">
                                <span class="text-sm"><?php echo e($archivo->nombre_archivo); ?></span>
                            </div>
                        <?php endif; ?>
...
<?php /**PATH /home/ubuntu/Documents/FondoSolidarioEntrega/FondoSolidarioEntrega/resources/views/salidas_educativas/print.blade.php ENDPATH**/ ?>