...
<div class="mx-auto px-4">
    ...
    <div class="mb-8">
        <nav class="flex items-center text-sm text-secondary-500 mb-4">
            ...
            <a href="<?php echo e(route('documentos.index')); ?>" class="hover:text-secondary-700">Documentos</a>
            <svg class="mx-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
            </svg>
            <span class="text-secondary-900"><?php echo e($modo == 'create' ? 'Nuevo Documento' : ($modo == 'edit' ? 'Editar Documento' : 'Detalles de Documento')); ?></span>
        </nav>
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-secondary-900">
                    <?php echo e($modo == 'create' ? 'Nuevo Documento' : ($modo == 'edit' ? 'Editar Documento' : 'Detalles de Documento')); ?>

                </h1>
                <p class="mt-1 text-sm text-secondary-600">
                    <?php echo e($modo == 'create' ? 'Complete los datos para registrar un nuevo documento institucional' : ($modo == 'edit' ? 'Modifique los datos del documento' : 'Información detallada del documento')); ?>
            ...
            <div class="flex space-x-3">
                ...
                <a href="<?php echo e(route('documentos.edit', $documento_id ?? 1)); ?>" class="inline-flex items-center px-4 py-2 border border-secondary-300 rounded-lg text-sm font-medium text-secondary-700 bg-white hover:bg-secondary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
    ...
    <div class="bg-white rounded-xl border border-secondary-200">
        ...
        <form action="<?php echo e($modo == 'create' ? route('documentos.index') : route('documentos.index')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6 p-6">
            <?php echo csrf_field(); ?>
            <?php if($modo == 'edit'): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e(isset($documento_id) && $documento_id == 1 ? 'Resolución Matrícula 2024' : (isset($documento_id) && $documento_id == 2 ? 'Plan de Estudios 2024' : (isset($documento_id) && $documento_id == 3 ? 'Habilitación Sanitaria' : ''))); ?>"
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            ...
                            <option value="administrativo" <?php echo e((isset($documento_id) && $documento_id == 1) ? 'selected' : ''); ?>>Administrativo</option>
                            <option value="academico" <?php echo e((isset($documento_id) && $documento_id == 2) ? 'selected' : ''); ?>>Académico</option>
                            <option value="legal" <?php echo e((isset($documento_id) && $documento_id == 3) ? 'selected' : ''); ?>>Legal</option>
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            ...
                            <option value="1" <?php echo e((isset($documento_id) && ($documento_id == 1 || $documento_id == 2)) ? 'selected' : ''); ?>>Colegio San Martín</option>
                            <option value="2" <?php echo e((isset($documento_id) && $documento_id == 3) ? 'selected' : ''); ?>>Instituto Belgrano</option>
                        </select>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e(isset($documento_id) && $documento_id == 1 ? '2024-02-15' : (isset($documento_id) && $documento_id == 2 ? '2024-03-01' : (isset($documento_id) && $documento_id == 3 ? '2023-01-20' : ''))); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm <?php echo e($modo == 'show' ? 'bg-secondary-50' : 'bg-white'); ?>"
                            value="<?php echo e(isset($documento_id) && $documento_id == 1 ? '2024-12-31' : (isset($documento_id) && $documento_id == 3 ? '2025-01-20' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-secondary-600">
                                    <label for="archivo" class="relative cursor-pointer bg-white rounded-md font-medium text-primary-600 hover:text-primary-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary-500">
                                        ...
                                        <input id="archivo" name="archivo" type="file" class="sr-only" accept=".pdf,.doc,.docx,.xls,.xlsx,.jpg,.jpeg,.png" <?php echo e($modo == 'create' ? 'required' : ''); ?>>
                                    </label>
                ...
                <div class="bg-secondary-50 rounded-lg p-4 flex items-center space-x-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-secondary-900 truncate">
                            <?php echo e(isset($documento_id) && $documento_id == 1 ? 'resolucion_matricula_2024.pdf' : (isset($documento_id) && $documento_id == 2 ? 'plan_estudios_2024.xlsx' : 'habilitacion_sanitaria.pdf')); ?>

                        </p>
                        <p class="text-sm text-secondary-500">
                            <?php echo e(isset($documento_id) && $documento_id == 1 ? '2.3 MB' : (isset($documento_id) && $documento_id == 2 ? '1.8 MB' : '1.1 MB')); ?> • Subido el <?php echo e(isset($documento_id) && $documento_id == 1 ? '15/02/2024' : (isset($documento_id) && $documento_id == 2 ? '01/03/2024' : '20/01/2023')); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1">
                        ...
                        <div class="block w-full px-3 py-2 bg-secondary-50 border border-secondary-300 rounded-lg text-sm text-secondary-900">
                            <?php echo e(isset($documento_id) && $documento_id == 1 ? 'Juan Pérez (Secretario)' : (isset($documento_id) && $documento_id == 2 ? 'María García (Directora Académica)' : 'Carlos López (Director)')); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="block w-full px-3 py-2 bg-secondary-50 border border-secondary-300 rounded-lg text-sm text-secondary-900">
                            <?php echo e(isset($documento_id) && $documento_id == 1 ? '15/02/2024 14:30' : (isset($documento_id) && $documento_id == 2 ? '01/03/2024 09:15' : '20/01/2023 16:45')); ?>
            ...
            <div class="flex items-center justify-between pt-6 border-t border-secondary-200">
                ...
                <a href="<?php echo e(route('documentos.index')); ?>" class="inline-flex items-center px-4 py-2 border border-secondary-300 rounded-lg text-sm font-medium text-secondary-700 bg-white hover:bg-secondary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Disco\Documentos\Personal\Proyectos\workana\SistemaFondoSolidario\FondoSolidarioSite\resources\views/livewire/documentos/form.blade.php ENDPATH**/ ?>