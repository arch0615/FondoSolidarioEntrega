<div x-data="{ modalAlumno: <?php if ((object) ('mostrar_modal_alumno') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('mostrar_modal_alumno'->value()); ?>')<?php echo e('mostrar_modal_alumno'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('mostrar_modal_alumno'); ?>')<?php endif; ?> }">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                    <div>
                        ...
                        <div class="mt-3 text-center sm:mt-5">
                            <h3 class="text-lg leading-6 font-medium text-gray-900"><?php echo e($tipoMensaje === 'success' ? '¡Éxito!' : '¡Atención!'); ?></h3>
                            <div class="mt-2">
    ...
    <!--[if BLOCK]><![endif]--><?php if($this->getErrorBag()->has('alumnos_seleccionados')): ?>
    <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: true }" x-show="show" x-transition>
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" @click="show = false"></div>
            <div class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                <div>
                    ...
                    <div class="mt-3 text-center sm:mt-5">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500"><?php echo e($this->getErrorBag()->first('alumnos_seleccionados')); ?></p>
                        </div>
                    </div>
                </div>
                <div class="mt-5 sm:mt-6">
    ...
    <!--[if BLOCK]><![endif]--><?php if(session('alumno_creado')): ?>
    <div class="fixed top-4 right-4 z-50 max-w-sm w-full bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded shadow-lg" x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 4000)">
        <div class="flex items-center">
            ...
            <span class="text-sm font-medium"><?php echo e(session('alumno_creado')); ?></span>
        </div>
    </div>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="bg-white rounded-xl border border-secondary-200">
            <form wire:submit.prevent="guardar" class="space-y-6 p-6">
                ...
                <div class="border-b border-secondary-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 <?php echo e($modo != 'create' ? 'md:grid-cols-2' : ''); ?> gap-6">
                        <div class="space-y-1">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="space-y-1">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['numero_expediente'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="flex gap-2">
                            <div class="flex-1 relative">
                                ...
                                <div class="absolute z-10 mt-1 w-full bg-white border border-secondary-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                                    ...
                                    <div wire:click="seleccionarAlumno(<?php echo e($alumno->id_alumno); ?>)" class="p-2 hover:bg-secondary-50 cursor-pointer border-b border-secondary-100">
                                        <div class="font-medium text-secondary-900"><?php echo e($alumno->nombre_completo); ?></div>
                                        <div class="text-sm text-secondary-600">DNI: <?php echo e($alumno->dni); ?></div>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <button wire:click="agregarAlumnoSeleccionado" type="button" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-lg font-medium text-sm text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200 <?php echo e($modo == 'show' ? 'opacity-50 cursor-not-allowed' : ''); ?>" <?php echo e($modo == 'show' ? 'disabled' : ''); ?>">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mb-4">
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <div class="flex items-center justify-between">
                                ...
                                <button wire:click="abrirModalAlumno" type="button" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-lg font-medium text-sm text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200 <?php echo e($modo == 'show' ? 'opacity-50 cursor-not-allowed' : ''); ?>" <?php echo e($modo == 'show' ? 'disabled' : ''); ?>">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="flex items-center justify-between bg-white border border-secondary-200 rounded-lg p-3 mb-2">
                                    <div class="flex-1">
                                        ...
                                        <div class="text-sm text-secondary-600">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($modo != 'show'): ?>
                                            <input wire:model.blur="alumnos_seleccionados.<?php echo e($alumno->indice_real); ?>.grado_seccion"
                                                   type="text"
                                                   ...
                                                   value="<?php echo e($alumno->grado_seccion_seleccionado); ?>"
                                                   placeholder="ej: 5° A">
                                            <?php else: ?>
                                            <?php echo e($alumno->grado_seccion_seleccionado); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="space-y-1">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['nuevo_alumno.familiar1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="space-y-1">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['nuevo_alumno.telefono_contacto1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <?php $__env->stopPush(); ?>
</div><?php /**PATH /home/ubuntu/Documents/FondoSolidarioEntrega/FondoSolidarioEntrega/resources/views/livewire/accidentes/form.blade.php ENDPATH**/ ?>