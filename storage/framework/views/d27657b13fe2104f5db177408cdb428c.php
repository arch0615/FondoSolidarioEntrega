                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="space-y-1">
                     ...
                     <div class="space-y-1">
                        ...
                        <select wire:model.live="filtro_escuela" id="filtro_escuela" class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php echo e($esUsuarioGeneral ? 'bg-secondary-50' : 'bg-white'); ?>" <?php echo e($esUsuarioGeneral ? 'disabled' : ''); ?>>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($esUsuarioGeneral): ?>
    ...
    <div class="bg-white rounded-xl border border-secondary-200 overflow-hidden">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-secondary-500 uppercase tracking-wider">
                            <button wire:click="sortBy('id_rol')" class="group inline-flex items-center hover:text-secondary-700">
                                Rol
                                <!--[if BLOCK]><![endif]--><?php if($sortField === 'id_rol'): ?>
                                    <!--[if BLOCK]><![endif]--><?php if($sortDirection === 'asc'): ?>
                                        <svg class="ml-2 w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"></path>
                                        </svg>
                ...
                <tbody class="bg-white divide-y divide-secondary-200">
                    ...
                    <tr class="hover:bg-secondary-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <!--[if BLOCK]><![endif]--><?php if($usuario->activo): ?>
        ...
        <div class="px-6 py-4 bg-secondary-50 border-t border-secondary-200 flex flex-col sm:flex-row items-center justify-between">
            <div class="text-sm text-secondary-700 mb-4 sm:mb-0">
                <!--[if BLOCK]><![endif]--><?php if($usuarios->total() > 0): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/passion/Documents/FondoSolidarioEntrega11/Fondo Solidario Entrega/resources/views/livewire/usuarios/index.blade.php ENDPATH**/ ?>