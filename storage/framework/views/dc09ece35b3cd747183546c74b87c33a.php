            ...
            <div class="p-6 flex-grow">
                <div class="flex justify-between items-start mb-4">
                    <div class="flex-1 min-w-0 pr-3">
                        <h2 class="text-xl font-semibold text-red-700 truncate"><?php echo e($accidente['numero_expediente']); ?></h2>
                        <div class="mt-1">
                            <?php if($accidente['cantidad_alumnos'] === 1): ?>
                                <p class="text-sm text-secondary-600 font-medium"><?php echo e($accidente['alumnos'][0]); ?></p>
                            <?php else: ?>
                                <p class="text-sm text-secondary-600 font-medium whitespace-nowrap">
                                    <?php echo e($accidente['alumnos'][0]); ?>

                                    <span class="text-xs text-secondary-500">+<?php echo e($accidente['cantidad_alumnos'] - 1); ?> más</span>
                                </p>
                                <p class="text-xs text-secondary-500 mt-1 whitespace-nowrap">
                                    <strong>Total:</strong> <?php echo e($accidente['cantidad_alumnos']); ?> alumnos involucrados
                                </p>
                            <?php endif; ?>
                        </div>
                        <p class="text-xs text-secondary-500 mt-1"><?php echo e($accidente['escuela']); ?></p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <?php if($accidente['estado'] == 'Activo'): ?>
                        ...
                        <?php endif; ?>
                        <?php if($accidente['protocolo_activado']): ?>
                        ...
                        <div x-data="{ open: false }" @click.away="open = false" class="relative">
                            ...
                            <div x-show="open"
                                 ...
                                 style="display: none;">
                                <a href="<?php echo e(route('accidentes.show', $accidente['id'])); ?>" class="flex items-center gap-2 px-4 py-2 text-sm text-secondary-700 hover:bg-secondary-100 hover:text-secondary-900 w-full text-left">
                                    <i class="fas fa-eye fa-fw text-secondary-400"></i>
                                    Consultar
                                </a>
                                <a href="<?php echo e(route('accidentes.edit', $accidente['id'])); ?>" class="flex items-center gap-2 px-4 py-2 text-sm text-secondary-700 hover:bg-secondary-100 hover:text-secondary-900 w-full text-left">
                ...
                <div class="mb-4 text-sm text-secondary-700 space-y-1">
                    <p><i class="fas fa-calendar-alt text-secondary-400 mr-2 fa-fw"></i><?php echo e(\Carbon\Carbon::parse($accidente['fecha_accidente'])->format('d/m/Y')); ?> - <?php echo e($accidente['hora_accidente']); ?></p>
                    <p><i class="fas fa-map-marker-alt text-secondary-400 mr-2 fa-fw"></i><?php echo e($accidente['lugar']); ?></p>
                ...
                <div class="border-t border-secondary-200 pt-4 mb-4">
                    ...
                    <div class="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
                        <p class="text-secondary-700">Derivaciones: <span class="font-semibold text-blue-600"><?php echo e($accidente['derivaciones']); ?></span></p>
                        <p class="text-secondary-700">Reintegros Total: <span class="font-semibold text-secondary-900"><?php echo e($accidente['reintegros_pendientes'] + $accidente['reintegros_autorizados'] + $accidente['reintegros_solicitando_info']); ?></span></p>
                        <?php if($accidente['reintegros_pendientes'] > 0): ?>
                        <p class="text-amber-700">R. Pendientes: <span class="font-semibold text-amber-800"><?php echo e($accidente['reintegros_pendientes']); ?></span></p>
                        <?php endif; ?>
                        <?php if($accidente['reintegros_autorizados'] > 0): ?>
                        <p class="text-green-700">R. Autorizados: <span class="font-semibold text-green-800"><?php echo e($accidente['reintegros_autorizados']); ?></span></p>
                        <?php endif; ?>
                        <?php if($accidente['reintegros_solicitando_info'] > 0): ?>
                        <p class="text-blue-700">R. Sol. Info: <span class="font-semibold text-blue-800"><?php echo e($accidente['reintegros_solicitando_info']); ?></span></p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="flex gap-2 mt-4">
                    <a href="<?php echo e(route('derivaciones.create', ['accidente_id' => $accidente['id']])); ?>" class="flex-1 inline-flex items-center justify-center px-3 py-2 bg-blue-600 border border-transparent rounded-lg font-medium text-xs text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
                        <i class="fas fa-file-medical mr-1"></i>
                        Generar Derivación
                    </a>
                    <a href="<?php echo e(route('reintegros.create', ['accidente_id' => $accidente['id']])); ?>" class="flex-1 inline-flex items-center justify-center px-3 py-2 bg-green-600 border border-transparent rounded-lg font-medium text-xs text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rican\OneDrive\Documentos\workana\Fondo Solidario\resources\views\livewire\accidentes\index.blade.php ENDPATH**/ ?>