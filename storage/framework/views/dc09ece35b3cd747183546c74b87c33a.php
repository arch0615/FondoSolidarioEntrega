<div>
    ...
    <div class="mx-auto px-4">
        ...
        <div class="bg-white rounded-xl border border-secondary-200 mb-6">
            <details class="group">
                ...
                <div class="px-6 pb-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 <?php echo e($es_usuario_general ? 'lg:grid-cols-3' : 'lg:grid-cols-4'); ?> gap-4">
                        <div class="space-y-1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__empty_1 = true; $__currentLoopData = $accidentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accidente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="p-6 flex-grow">
                    <div class="flex justify-between items-start mb-4">
                        <div class="flex-1 min-w-0 pr-3">
                            ...
                            <div class="mt-1">
                                <?php if($accidente->alumnos->count() === 0): ?>
    ...
    <?php $__env->stopPush(); ?>
</div><?php /**PATH C:\Users\rican\OneDrive\Documentos\workana\Fondo Solidario\resources\views\livewire\accidentes\index.blade.php ENDPATH**/ ?>