...
<div class="mx-auto px-4">
    ...
    <div class="mb-8">
        <nav class="flex items-center text-sm text-secondary-500 mb-4">
            ...
            <a href="<?php echo e(route('empleados.index')); ?>" class="hover:text-secondary-700">Empleados</a>
            <svg class="mx-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
            </svg>
            <span class="text-secondary-900"><?php echo e($modo == 'create' ? 'Nuevo Empleado' : ($modo == 'edit' ? 'Editar Empleado' : 'Detalles de Empleado')); ?></span>
        </nav>
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-secondary-900">
                    <?php echo e($modo == 'create' ? 'Nuevo Empleado' : ($modo == 'edit' ? 'Editar Empleado' : 'Detalles de Empleado')); ?>

                </h1>
                <p class="mt-1 text-sm text-secondary-600">
                    <?php echo e($modo == 'create' ? 'Complete los datos para registrar un nuevo empleado' : ($modo == 'edit' ? 'Modifique los datos del empleado' : 'Información detallada del empleado')); ?>
            ...
            <div class="flex space-x-3">
                ...
                <a href="<?php echo e(route('empleados.edit', $empleado_id ?? 1)); ?>" class="inline-flex items-center px-4 py-2 border border-secondary-300 rounded-lg text-sm font-medium text-secondary-700 bg-white hover:bg-secondary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
    ...
    <div class="bg-white rounded-xl border border-secondary-200">
        ...
        <form action="<?php echo e($modo == 'create' ? route('empleados.index') : route('empleados.index')); ?>" method="POST" class="space-y-6 p-6">
            <?php echo csrf_field(); ?>
            <?php if($modo == 'edit'): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            placeholder="Ej: Juan"
                            value="<?php echo e($empleado_id ?? '' == 1 ? 'Juan' : ($empleado_id ?? '' == 2 ? 'María' : '')); ?>"
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($empleado_id ?? '' == 1 ? 'Pérez' : ($empleado_id ?? '' == 2 ? 'García' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($empleado_id ?? '' == 1 ? '12345678' : ($empleado_id ?? '' == 2 ? '87654321' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($empleado_id ?? '' == 1 ? '20-12345678-9' : ($empleado_id ?? '' == 2 ? '27-87654321-2' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($empleado_id ?? '' == 1 ? '(351) 111-2222' : ($empleado_id ?? '' == 2 ? '(351) 333-4444' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($empleado_id ?? '' == 1 ? 'juan.perez@sanmartin.edu.ar' : ($empleado_id ?? '' == 2 ? 'maria.garcia@belgrano.edu.ar' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($empleado_id ?? '' == 1 ? 'Av. Siempre Viva 742, Córdoba' : ($empleado_id ?? '' == 2 ? 'Calle Falsa 123, Córdoba' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            <option value="">Seleccione una escuela</option>
                             ...
                             <option value="1" <?php echo e(($empleado_id ?? '' == 1) ? 'selected' : ''); ?>>Colegio San Martín</option>
                             <option value="2" <?php echo e(($empleado_id ?? '' == 2) ? 'selected' : ''); ?>>Instituto Belgrano</option>
                        </select>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($empleado_id ?? '' == 1 ? 'Docente' : ($empleado_id ?? '' == 2 ? 'Preceptora' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($empleado_id ?? '' == 1 ? '2020-03-01' : ($empleado_id ?? '' == 2 ? '2018-08-15' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            id="fecha_egreso"
                            class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm <?php echo e($modo == 'show' ? 'bg-secondary-50' : 'bg-white'); ?>"
                            value="<?php echo e($empleado_id ?? '' == 2 ? '2024-01-31' : ''); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                ...
                <div class="flex items-center">
                    <div class="flex items-center h-5">
                        <input
                            ...
                            <?php echo e(($modo == 'create' || ($empleado_id ?? '' == 1 && $modo != 'create')) ? 'checked' : ''); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rican\OneDrive\Documentos\workana\Fondo Solidario\resources\views\livewire\empleados\form.blade.php ENDPATH**/ ?>