                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        >
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($empleado->id_empleado); ?>"><?php echo e($empleado->nombre); ?> <?php echo e($empleado->apellido); ?> (DNI: <?php echo e($empleado->dni); ?>)</option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        </select>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="space-y-1">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['id_parentesco'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="space-y-1">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['porcentaje'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
            ...
            <div class="flex items-center justify-between pt-6 border-t border-secondary-200">
                ...
                <button type="submit" class="inline-flex items-center px-6 py-2 bg-primary-600 border border-transparent rounded-lg font-medium text-sm text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
                    ...
                    <span wire:loading wire:target="guardar">
                        <?php echo e($modo == 'create' ? 'Creando...' : 'Actualizando...'); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\rican\OneDrive\Documentos\workana\Fondo Solidario\resources\views/livewire/beneficiarios_svo/form.blade.php ENDPATH**/ ?>