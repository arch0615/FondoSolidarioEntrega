        ...
        <div class="mb-8">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-3">
                    <a href="<?php echo e(route('salidas_educativas.edit', $salida_id)); ?>" class="inline-flex items-center px-4 py-2 border border-secondary-300 rounded-lg text-sm font-medium text-secondary-700 bg-white hover:bg-secondary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-1">
                            ...
                            <?php $__errorArgs = ['cantidad_alumnos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\rican\OneDrive\Documentos\workana\Fondo Solidario\resources\views\livewire\salidas_educativas\form.blade.php ENDPATH**/ ?>