    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg border border-primary-200 p-6 shadow-sm">
            ...
            <div class="space-y-3">
                ...
                <a href="<?php echo e(route('documentos.create')); ?>" class="w-full flex items-center gap-3 p-3 border-2 border-primary-200 text-primary-600 hover:bg-primary-25 hover:border-primary-300 rounded-lg transition-all duration-200">
