<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php $__empty_1 = true; $__currentLoopData = $escuelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $escuela): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="p-6 flex-grow">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        ...
                        <p class="text-xs text-secondary-500">Código: <?php echo e($escuela->codigo_escuela); ?></p>
                    </div>
                ...
                <div class="border-t border-secondary-200 pt-4 mb-4">
                    ...
                    <div class="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
                        <p>Alumnos: <span class="font-semibold"><?php echo e($escuela->alumnos_count); ?></span></p>
                        <p>Empleados: <span class="font-semibold"><?php echo e($escuela->empleados_count); ?></span></p>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\rican\OneDrive\Documentos\workana\Fondo Solidario\resources\views\livewire\escuelas\index.blade.php ENDPATH**/ ?>