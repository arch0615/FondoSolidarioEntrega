<div class="mx-auto px-4" x-data="{ 
    showDetail: <?php if ((object) ('showDetailPanel') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showDetailPanel'->value()); ?>')<?php echo e('showDetailPanel'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showDetailPanel'); ?>')<?php endif; ?>,
                        ...
                        <tr class="hover:bg-secondary-50 transition-colors duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-secondary-900 flex items-center">
                                    <?php if($reintegro->estadoReintegro->descripcion == 'Nuevo'): ?>
        ...
        <?php if($reintegroSeleccionado): ?>
            <div class="h-full flex flex-col">
                <div class="flex justify-between items-center px-6 py-4 bg-secondary-50 border-b border-secondary-200">
                    <h2 class="text-lg font-semibold text-secondary-900">Detalle del Reintegro: REI-<?php echo e(str_pad($reintegroSeleccionado->id_reintegro, 3, '0', STR_PAD_LEFT)); ?></h2>
                ...
                <div class="flex-grow p-6 overflow-y-auto">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div><span class="font-medium text-secondary-600">ID Accidente:</span> <span class="text-secondary-900"><?php echo e($reintegroSeleccionado->accidente->id_accidente_entero ?? 'N/A'); ?></span></div>
                            <div><span class="font-medium text-secondary-600">Alumno:</span> <span class="text-secondary-900"><?php echo e($reintegroSeleccionado->alumno->nombre_completo ?? 'N/A'); ?></span></div>
                            ...
                            <div><span class="font-medium text-secondary-600">Fecha Solicitud:</span> <span class="text-secondary-900"><?php echo e($reintegroSeleccionado->fecha_solicitud ? $reintegroSeleccionado->fecha_solicitud->format('d/m/Y') : 'N/A'); ?></span></div>
                            <div><span class="font-medium text-secondary-600">Tipo de Gasto:</span> <span class="text-secondary-900"><?php echo e($reintegroSeleccionado->tipoGasto->descripcion ?? 'N/A'); ?></span></div>
                            <div class="md:col-span-2"><span class="font-medium text-secondary-600">Descripción del Gasto:</span> <span class="text-secondary-900"><?php echo e($reintegroSeleccionado->descripcion_gasto); ?></span></div>
                            <div class="md:col-span-2"><span class="font-medium text-secondary-600">Monto Solicitado:</span> <span class="text-secondary-900 font-bold text-lg">$ <?php echo e(number_format($reintegroSeleccionado->monto_solicitado, 2)); ?></span></div>
                            <div><span class="font-medium text-secondary-600">Estado Actual:</span> 
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($reintegroSeleccionado->estadoReintegro->color_clase ?? 'bg-secondary-100 text-secondary-800'); ?>">
                                    <?php echo e($reintegroSeleccionado->estadoReintegro->descripcion ?? 'Sin Estado'); ?>

                                </span>
                            </div>
                            <?php if($reintegroSeleccionado->observaciones_auditor): ?>
                                <div class="md:col-span-2"><span class="font-medium text-secondary-600">Observaciones Auditor:</span> <span class="text-secondary-900"><?php echo e($reintegroSeleccionado->observaciones_auditor); ?></span></div>
                            <?php endif; ?>
                            <?php if($reintegroSeleccionado->monto_autorizado): ?>
                                <div><span class="font-medium text-secondary-600">Monto Autorizado:</span> <span class="text-secondary-900 font-bold text-lg">$ <?php echo e(number_format($reintegroSeleccionado->monto_autorizado, 2)); ?></span></div>
                            <?php endif; ?>
                            <?php if($reintegroSeleccionado->fecha_autorizacion): ?>
                            ...
                            <?php endif; ?>
                            <?php if($reintegroSeleccionado->fecha_pago): ?>
                            ...
                            <?php endif; ?>
                            <?php if($reintegroSeleccionado->numero_transferencia): ?>
                                <div><span class="font-medium text-secondary-600">No. Transferencia:</span> <span class="text-secondary-900"><?php echo e($reintegroSeleccionado->numero_transferencia); ?></span></div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <?php $__empty_1 = true; $__currentLoopData = $reintegroSeleccionado->archivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li class="flex items-center justify-between p-3 bg-secondary-50 rounded-lg border border-secondary-200">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm font-medium text-secondary-800"><?php echo e($doc->nombre_archivo); ?></span>
                                    </div>
                                    <a href="<?php echo e(Storage::url($doc->ruta_archivo)); ?>" target="_blank" class="inline-flex items-center px-3 py-1.5 bg-white border border-secondary-300 rounded-md text-xs font-medium text-secondary-700 hover:bg-secondary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                                        Ver
                                    </a>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="px-6 py-4 bg-secondary-50 border-t border-secondary-200 flex justify-end items-center space-x-3">
                    <?php if(optional($reintegroSeleccionado)->id_estado_reintegro == $estadoAutorizadoId): ?>
    ...
    <div x-show="showInfoModal"
        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 m-4" @click.away="showInfoModal = false">
            ...
            <div>
                ...
                <?php $__errorArgs = ['solicitudInfoTexto'];
        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 m-4" @click.away="showAprobacionModal = false">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <?php $__errorArgs = ['montoAutorizado'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <?php $__errorArgs = ['observacionesAuditor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 m-4" @click.away="showPagoModal = false">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <?php $__errorArgs = ['numeroTransferencia'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
