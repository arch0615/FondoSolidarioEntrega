        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-secondary-200">
                ...
                <tbody class="bg-white divide-y divide-secondary-200">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $operaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-secondary-50 transition-colors duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-secondary-900"><?php echo e($operacion->usuario->email ?? 'N/A'); ?></div>
                            <div class="text-sm text-secondary-500"><?php echo e($operacion->usuario->nombre ?? ''); ?> <?php echo e($operacion->usuario->apellido ?? ''); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-secondary-900"><?php echo e($operacion->tabla_afectada); ?></div>
                            <div class="text-sm text-secondary-500">ID: <?php echo e($operacion->id_registro); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                <?php switch($operacion->accion):
                                    case ('CREAR'): ?> bg-success-100 text-success-800 <?php break; ?>
                                    <?php case ('ACTUALIZAR'): ?> bg-info-100 text-info-800 <?php break; ?>
                                    <?php case ('ELIMINAR'): ?> bg-danger-100 text-danger-800 <?php break; ?>
                                    <?php default: ?> bg-secondary-100 text-secondary-800
                                <?php endswitch; ?>
                            ">
                                <?php echo e($operacion->accion); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-secondary-900"><?php echo e($operacion->fecha_hora->format('d/m/Y H:i:s')); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <button wire:click="mostrarDetalles('<?php echo e($operacion->datos_anteriores); ?>', '<?php echo e($operacion->datos_nuevos); ?>')" class="p-2 text-secondary-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors duration-200" title="Ver detalles">
        ...
        <div class="px-6 py-4 bg-secondary-50 border-t border-secondary-200">
            <div class="flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
                <div class="text-sm text-secondary-700">
                    <!--[if BLOCK]><![endif]--><?php if($operaciones->total() > 0): ?>
                        Mostrando <?php echo e($operaciones->firstItem()); ?> a <?php echo e($operaciones->lastItem()); ?> de <?php echo e($operaciones->total()); ?> resultados
                    <?php else: ?>
                        No hay resultados para mostrar
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
                <!--[if BLOCK]><![endif]--><?php if($operaciones->hasPages()): ?>
                    <div class="flex-shrink-0">
                        <?php echo e($operaciones->links()); ?>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-3 max-h-60 overflow-y-auto">
                            <pre class="text-sm text-gray-600 whitespace-pre-wrap"><?php echo e($datosAnteriores); ?></pre>
                        </div>
                    </div>
                    <div>
                        <h4 class="text-sm font-medium text-gray-700 mb-2">Datos Nuevos:</h4>
                        <div class="bg-gray-50 rounded-lg p-3 max-h-60 overflow-y-auto">
                            <pre class="text-sm text-gray-600 whitespace-pre-wrap"><?php echo e($datosNuevos); ?></pre>
                        </div>
                    </div>
                </div>
                <div class="mt-5">
...
<script>
    function exportarOperaciones(formato) {
        ...
        switch(formato) {
            case 'csv':
                url = '<?php echo e(route("auditoria.export.operaciones.csv")); ?>';
                break;
            case 'excel':
                url = '<?php echo e(route("auditoria.export.operaciones.excel")); ?>';
                break;
            case 'pdf':
                url = '<?php echo e(route("auditoria.export.operaciones.pdf")); ?>';
                break;
        }
...
<?php $__env->stopPush(); ?><?php /**PATH /home/passion/Documents/FondoSolidarioEntrega11/Fondo Solidario Entrega/resources/views/livewire/auditoria/operaciones-sistema.blade.php ENDPATH**/ ?>