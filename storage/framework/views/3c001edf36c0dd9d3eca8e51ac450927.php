...
<div class="mx-auto px-4">
    ...
    <div class="mb-8">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                ...
                <a href="<?php echo e(route('prestadores.edit', $prestador_id ?? 1)); ?>" class="inline-flex items-center px-4 py-2 border border-secondary-300 rounded-lg text-sm font-medium text-secondary-700 bg-white hover:bg-secondary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
    ...
    <div class="bg-white rounded-xl border border-secondary-200">
        ...
        <form action="<?php echo e($modo == 'create' ? route('prestadores.index') : route('prestadores.index')); ?>" method="POST" class="space-y-6 p-6">
            <?php echo csrf_field(); ?>
            <?php if($modo == 'edit'): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($prestador_id ?? '' == 1 ? 'Hospital San Roque' : ($prestador_id ?? '' == 2 ? 'Clínica Privada Vélez Sarsfield' : ($prestador_id ?? '' == 3 ? 'Dr. Carlos Mendez' : ''))); ?>"
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            ...
                            <option value="hospital" <?php echo e(($prestador_id ?? '' == 1) ? 'selected' : ''); ?>>Hospital</option>
                            <option value="clinica" <?php echo e(($prestador_id ?? '' == 2) ? 'selected' : ''); ?>>Clínica</option>
                            <option value="medico" <?php echo e(($prestador_id ?? '' == 3) ? 'selected' : ''); ?>>Médico</option>
                        ...
                        <div class="flex items-center">
                            <div class="flex items-center h-5">
                                <input
                                    ...
                                    <?php echo e(($prestador_id ?? '' == 1) ? 'checked' : ''); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($prestador_id ?? '' == 1 ? 'Av. Vélez Sarsfield 562, Córdoba' : ($prestador_id ?? '' == 2 ? 'Colón 1538, Córdoba' : ($prestador_id ?? '' == 3 ? 'Independencia 1425, Consultorio 3B, Córdoba' : ''))); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($prestador_id ?? '' == 1 ? '(351) 421-7000' : ($prestador_id ?? '' == 2 ? '(351) 424-9600' : ($prestador_id ?? '' == 3 ? '(351) 156-789123' : ''))); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($prestador_id ?? '' == 1 ? 'info@sanroque.com.ar' : ($prestador_id ?? '' == 2 ? 'recepcion@velezs.com.ar' : ($prestador_id ?? '' == 3 ? 'dr.mendez@gmail.com' : ''))); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea
                            ...
                            required
                        ><?php echo e($prestador_id ?? '' == 1 ? 'Cardiología, Neurología, Pediatría, Traumatología, Medicina General, Cirugía' : ($prestador_id ?? '' == 2 ? 'Medicina General, Ginecología, Oftalmología, Dermatología' : ($prestador_id ?? '' == 3 ? 'Pediatría, Medicina del Deporte' : ''))); ?></textarea>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                            <div class="flex items-center">
                                <input type="checkbox" id="esp_medicina_general" class="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500" <?php echo e($modo == 'show' ? 'disabled' : ''); ?>>
                                <label for="esp_medicina_general" class="ml-2 text-sm text-secondary-700">Medicina General</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="esp_pediatria" class="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500" <?php echo e(($prestador_id ?? '' == 1 || $prestador_id ?? '' == 3) ? 'checked' : ''); ?> <?php echo e($modo == 'show' ? 'disabled' : ''); ?>>
                                <label for="esp_pediatria" class="ml-2 text-sm text-secondary-700">Pediatría</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="esp_cardiologia" class="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500" <?php echo e(($prestador_id ?? '' == 1) ? 'checked' : ''); ?> <?php echo e($modo == 'show' ? 'disabled' : ''); ?>>
                                <label for="esp_cardiologia" class="ml-2 text-sm text-secondary-700">Cardiología</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="esp_neurologia" class="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500" <?php echo e(($prestador_id ?? '' == 1) ? 'checked' : ''); ?> <?php echo e($modo == 'show' ? 'disabled' : ''); ?>>
                                <label for="esp_neurologia" class="ml-2 text-sm text-secondary-700">Neurología</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="esp_traumatologia" class="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500" <?php echo e(($prestador_id ?? '' == 1) ? 'checked' : ''); ?> <?php echo e($modo == 'show' ? 'disabled' : ''); ?>>
                                <label for="esp_traumatologia" class="ml-2 text-sm text-secondary-700">Traumatología</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="esp_ginecologia" class="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500" <?php echo e(($prestador_id ?? '' == 2) ? 'checked' : ''); ?> <?php echo e($modo == 'show' ? 'disabled' : ''); ?>>
                                <label for="esp_ginecologia" class="ml-2 text-sm text-secondary-700">Ginecología</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="esp_oftalmologia" class="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500" <?php echo e(($prestador_id ?? '' == 2) ? 'checked' : ''); ?> <?php echo e($modo == 'show' ? 'disabled' : ''); ?>>
                                <label for="esp_oftalmologia" class="ml-2 text-sm text-secondary-700">Oftalmología</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="esp_dermatologia" class="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500" <?php echo e($modo == 'show' ? 'disabled' : ''); ?>>
                ...
                <div class="flex items-center">
                    <div class="flex items-center h-5">
                        <input
                            ...
                            id="activo"
                            class="w-4 h-4 text-primary-600 bg-white border-secondary-300 rounded focus:ring-primary-500 focus:ring-2"
                            <?php echo e(($modo == 'create' || ($prestador_id ?? '' == 1 || $prestador_id ?? '' == 2) && $modo != 'create') ? 'checked' : ''); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rican\OneDrive\Documentos\workana\Fondo Solidario\resources\views\livewire\prestadores\form.blade.php ENDPATH**/ ?>