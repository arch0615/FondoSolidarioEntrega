                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-secondary-200">
                        ...
                        <tbody class="bg-white divide-y divide-secondary-200">
                            <?php $__empty_1 = true; $__currentLoopData = $pendientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reintegro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-secondary-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-secondary-900"><?php echo e(\Carbon\Carbon::parse($reintegro['fecha_autorizacion'])->format('d/m/Y')); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="text-sm font-bold text-secondary-900">$ <?php echo e(number_format($reintegro['monto'], 2)); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <button wire:click="iniciarPago(<?php echo e($reintegro['id_reintegro']); ?>)" class="inline-flex items-center px-4 py-2 bg-success-600 border border-transparent rounded-lg font-medium text-sm text-white hover:bg-success-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-success-500 transition-colors duration-200">
            ...
            <div class="bg-white rounded-xl border border-secondary-200 overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-secondary-200">
                        ...
                        <tbody class="bg-white divide-y divide-secondary-200">
                            <?php $__empty_1 = true; $__currentLoopData = $historialPaginado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reintegro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-secondary-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-secondary-900"><?php echo e($reintegro['id_reintegro']); ?></div>
                                     <div class="text-xs text-secondary-500">Accidente #<?php echo e($reintegro['id_accidente']); ?></div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-secondary-900"><?php echo e(\Carbon\Carbon::parse($reintegro['fecha_pago'])->format('d/m/Y')); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                ...
                <div class="px-6 py-4 bg-secondary-50 border-t border-secondary-200 flex flex-col sm:flex-row items-center justify-between">
                    ...
                    <?php if($historialPaginado->hasPages()): ?>
                        <nav class="inline-flex rounded-lg shadow-sm" aria-label="Paginación">
                            
                            <?php if($historialPaginado->onFirstPage()): ?>
                            ...
                            <?php $__currentLoopData = $historialPaginado->links()->elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if(is_array($element)): ?>
                                    <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($page == $historialPaginado->currentPage()): ?>
                            ...
                            <?php if($historialPaginado->hasMorePages()): ?>
                ...
                <div class="mt-3 text-center">
                    ...
                    <div class="mt-2 px-7 py-3">
                        <p class="text-sm text-secondary-500">
                            Estás a punto de registrar el pago para el reintegro #<?php echo e($reintegroSeleccionado['id_reintegro']); ?> del alumno <strong><?php echo e($reintegroSeleccionado['nombre_alumno']); ?></strong> por un monto de <strong>$<?php echo e(number_format($reintegroSeleccionado['monto'], 2)); ?></strong>.
                        </p>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <?php $__errorArgs = ['numero_transferencia'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
<?php /**PATH C:\Users\rican\OneDrive\Documentos\workana\Fondo Solidario\resources\views\livewire\gestion-pagos\index.blade.php ENDPATH**/ ?>