...
<div class="mx-auto px-4">
    ...
    <div class="bg-white rounded-xl border border-secondary-200">
        <form action="<?php echo e($modo == 'create' ? route('accidentes.index') : route('accidentes.index')); ?>" method="POST" class="space-y-6 p-6">
            <?php echo csrf_field(); ?>
            <?php if($modo == 'edit'): ?>
            ...
            <div class="border-b border-secondary-200 pb-6">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        <button
                            type="button"
                            id="btn_nuevo_alumno"
                            class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-lg font-medium text-sm text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200 <?php echo e($modo == 'show' ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                            <?php if($modo == 'show'): ?> disabled <?php endif; ?>
                        >
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div id="alumnos_seleccionados" class="space-y-2">
                    ...
                    <div id="lista_alumnos" class="min-h-[60px] border border-secondary-200 rounded-lg p-3 bg-secondary-50">
                        ...
                        <?php if(empty($alumnosSeleccionados)): ?>
                            <p class="text-sm text-secondary-500 italic">No hay alumnos seleccionados</p>
                        <?php else: ?>
                            <?php $__currentLoopData = $alumnosSeleccionados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alumno): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="alumno-item flex items-center justify-between bg-white border border-secondary-200 rounded-lg p-3" data-id="<?php echo e($alumno['id']); ?>">
                                <div class="flex-1">
                                    <div class="font-medium text-secondary-900"><?php echo e($alumno['nombre']); ?></div>
                                    <div class="text-sm text-secondary-600"><?php echo e($alumno['grado']); ?> - DNI: <?php echo e($alumno['dni']); ?></div>
                                </div>
                                <?php if($modo != 'show'): ?>
                                <button type="button" class="btn-remover-alumno text-red-600 hover:text-red-800 p-1" data-id="<?php echo e($alumno['id']); ?>">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                    </svg>
                                </button>
                                <?php endif; ?>
                                <input type="hidden" name="alumnos_ids[]" value="<?php echo e($alumno['id']); ?>">
                            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($accidente_id ?? '' == 1 ? '2024-01-15' : ($accidente_id ?? '' == 2 ? '2024-01-20' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            id="hora_accidente"
                            class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php echo e($modo == 'show' ? 'bg-secondary-50' : 'bg-white'); ?>"
                            value="<?php echo e($accidente_id ?? '' == 1 ? '10:30' : ($accidente_id ?? '' == 2 ? '14:15' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($accidente_id ?? '' == 1 ? 'Patio de juegos' : ($accidente_id ?? '' == 2 ? 'Aula de educación física' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <textarea
                            ...
                            required><?php echo e($accidente_id ?? '' == 1 ? 'El alumno se encontraba jugando en el patio durante el recreo cuando se resbaló y cayó, golpeándose el brazo derecho contra el suelo.' : ($accidente_id ?? '' == 2 ? 'Durante la clase de educación física, la alumna tropezó mientras corría y se golpeó la rodilla.' : '')); ?></textarea>
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($accidente_id ?? '' == 1 ? 'Fractura de brazo' : ($accidente_id ?? '' == 2 ? 'Contusión en rodilla' : '')); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 flex items-center">
                        <div class="flex items-center h-5">
                            <input
                                ...
                                <?php echo e(($modo == 'create' || ($accidente_id ?? '' == 1 && $modo != 'create')) ? 'checked' : ''); ?>
                    ...
                    <div class="flex items-center">
                        <div class="flex items-center h-5">
                            <input
                                ...
                                class="w-4 h-4 text-red-600 bg-white border-secondary-300 rounded focus:ring-red-500 focus:ring-2"
                                <?php echo e(($accidente_id ?? '' == 1 && $modo != 'create') ? 'checked' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            id="hora_llamada"
                            class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php echo e($modo == 'show' ? 'bg-secondary-50' : 'bg-white'); ?>"
                            value="<?php echo e($accidente_id ?? '' == 1 ? '10:35' : ''); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($accidente_id ?? '' == 1 ? 'Emergencias Médicas FS' : ''); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($accidente_id ?? '' == 1 ? 'EXP-2024-001' : ($accidente_id ?? '' == 2 ? 'EXP-2024-002' : '')); ?>"
                            readonly
                        >
                    ...
                    <div class="space-y-1">
                        ...
                        <select
                            ...
                            class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php echo e($modo == 'show' ? 'bg-secondary-50' : 'bg-white'); ?>"
                            <?php echo e($modo == 'show' ? 'disabled' : ''); ?>>
                            <option value="Activo" <?php echo e(($accidente_id ?? '' == 1) ? 'selected' : ''); ?>>Activo</option>
            ...
            <div class="border-b border-secondary-200 pb-6">
                ...
                <div id="lista_archivos_container">
                    ...
                    <div id="lista_archivos" class="space-y-2">
                        ...
                        <?php else: ?>
                            <?php $__currentLoopData = $archivosExistentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $archivo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="archivo-item flex items-center justify-between bg-white border border-secondary-200 rounded-lg p-3" data-index="<?php echo e($index); ?>">
                                <div class="flex items-center flex-1">
                                    <!-- Icono según tipo de archivo -->
                                    <?php if($archivo['tipo'] == 'pdf'): ?>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="font-medium text-secondary-900 truncate"><?php echo e($archivo['nombre']); ?></div>
                                        <div class="text-sm text-secondary-600">
                                            <?php echo e($archivo['tamaño']); ?> • <?php echo e($archivo['fecha']); ?>
                                ...
                                <div class="flex items-center ml-4">
                                    ...
                                    <?php if($modo != 'show'): ?>
                                    <!-- Botón para eliminar -->
                                    <button type="button" class="btn-eliminar-archivo text-red-600 hover:text-red-800 p-1" data-index="<?php echo e($index); ?>" title="Eliminar archivo">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rican\OneDrive\Documentos\workana\Fondo Solidario\resources\views\livewire\accidentes\form.blade.php ENDPATH**/ ?>