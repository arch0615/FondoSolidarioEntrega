...
<div class="mx-auto px-4">
    ...
    <div class="bg-white rounded-xl border border-secondary-200">
        ...
        <form action="<?php echo e($modo == 'create' ? route('usuarios.index') : route('usuarios.index')); ?>" method="POST" class="space-y-6 p-6">
            <?php echo csrf_field(); ?>
            <?php if($modo == 'edit'): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            placeholder="Ej: Ana"
                            value="<?php echo e($usuario_id ?? '' == 1 ? 'Ana' : ($usuario_id ?? '' == 2 ? 'Carlos' : ($usuario_id ?? '' == 3 ? 'Luis' : ''))); ?>"
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($usuario_id ?? '' == 1 ? 'López' : ($usuario_id ?? '' == 2 ? 'Ruiz' : ($usuario_id ?? '' == 3 ? 'Martínez' : ''))); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="<?php echo e($usuario_id ?? '' == 1 ? 'ana.lopez@sanmartin.edu.ar' : ($usuario_id ?? '' == 2 ? 'carlos.ruiz@admin.jaec.org' : ($usuario_id ?? '' == 3 ? 'dr.martinez@medico.jaec.org' : ''))); ?>"
                            <?php echo e($modo == 'show' ? 'readonly' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            placeholder="<?php echo e($modo == 'create' ? 'Ingrese una contraseña segura' : 'Dejar vacío para mantener la actual'); ?>"
                            <?php echo e($modo == 'create' ? 'required' : ''); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            ...
                            <option value="1" <?php echo e(($usuario_id ?? '' == 1) ? 'selected' : ''); ?>>Usuario General</option>
                            <option value="2" <?php echo e(($usuario_id ?? '' == 2) ? 'selected' : ''); ?>>Administrador</option>
                            <option value="3" <?php echo e(($usuario_id ?? '' == 3) ? 'selected' : ''); ?>>Médico Auditor</option>
                        </select>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            ...
                            <option value="1" <?php echo e(($usuario_id ?? '' == 1) ? 'selected' : ''); ?>>Colegio San Martín</option>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center">
                    <div class="flex items-center h-5">
                        <input
                            ...
                            <?php echo e(($modo == 'create' || ($usuario_id ?? '' != 3 && $modo != 'create')) ? 'checked' : ''); ?>
                ...
                <div class="flex items-center">
                    <div class="flex items-center h-5">
                        <input
                            ...
                            id="email_verificado"
                            class="w-4 h-4 text-primary-600 bg-white border-secondary-300 rounded focus:ring-primary-500 focus:ring-2"
                            <?php echo e(($usuario_id ?? '' != 3) ? 'checked' : ''); ?>
                ...
                <div class="flex items-center">
                    <div class="flex items-center h-5">
                        <input
                            type="checkbox"
                            name="enviar_verificacion"
                            id="enviar_verificacion"
                            class="w-4 h-4 text-primary-600 bg-white border-secondary-300 rounded focus:ring-primary-500 focus:ring-2"
                            checked
                        >
                    </div>
                    <div class="ml-3">
                        <label for="enviar_verificacion" class="text-sm font-medium text-secondary-700">
                            Enviar Email de Verificación
                        </label>
                        <p class="text-xs text-secondary-500">Se enviará un correo al usuario para verificar su cuenta</p>
                    </div>
                </div>
                <?php endif; ?>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Disco\Documentos\Personal\Proyectos\workana\SistemaFondoSolidario\FondoSolidarioSite\resources\views/livewire/usuarios/form.blade.php ENDPATH**/ ?>