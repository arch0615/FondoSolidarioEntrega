    ...
    <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: true }" x-show="show" x-transition>
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                <div>
                    <div class="mx-auto flex items-center justify-center h-12 w-12 rounded-full <?php echo e($tipoMensaje === 'success' ? 'bg-green-100' : ($tipoMensaje === 'info' ? 'bg-blue-100' : 'bg-red-100')); ?>">
                ...
                <div class="mt-5 sm:mt-6">
                    ...
                    <?php elseif($modo == 'edit' && $tipoMensaje === 'success'): ?>
                        <button @click="show = false" wire:click="redirigirAlListado" type="button" class="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 hover:bg-green-700 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:text-sm">
                            Aceptar
                        </button>
                    <?php else: ?>
                        <button @click="show = false" wire:click="limpiarMensaje" type="button" class="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 <?php echo e($tipoMensaje === 'success' ? 'bg-green-600 hover:bg-green-700' : ($tipoMensaje === 'info' ? 'bg-blue-600 hover:bg-blue-700' : 'bg-red-600 hover:bg-red-700')); ?> text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 <?php echo e($tipoMensaje === 'success' ? 'focus:ring-green-500' : ($tipoMensaje === 'info' ? 'focus:ring-blue-500' : 'focus:ring-red-500')); ?> sm:text-sm">
                            <!--[if BLOCK]><![endif]--><?php if($tipoMensaje === 'info'): ?>
                                Entendido
                            <?php else: ?>
                                Aceptar
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="border-b border-secondary-200 pb-6">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center space-x-4">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(count($beneficiarios) > 0): ?>
                        <div class="text-sm">
                ...
                <!--[if BLOCK]><![endif]--><?php if($errorBeneficiarios): ?>
                <div class="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                    <div class="flex">
                        <svg class="w-5 h-5 text-red-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <p class="text-sm text-red-700"><?php echo e($errorBeneficiarios); ?></p>
                    </div>
                </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-secondary-200">
                        ...
                        <tbody class="bg-white divide-y divide-secondary-200">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $beneficiarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $beneficiario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-secondary-50 <?php echo e((isset($beneficiario['marcado_para_eliminar']) && $beneficiario['marcado_para_eliminar']) ? 'opacity-50 bg-red-50' : ''); ?>">
                                <!-- Nombre -->
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <!--[if BLOCK]><![endif]--><?php if($beneficiario['modo_edicion'] ?? false): ?>
                                        <input wire:model="beneficiarios.<?php echo e($index); ?>.nombre"
                                               type="text"
                                               ...
                                               placeholder="Nombre">
                                    <?php else: ?>
                                        <span class="text-sm font-medium text-secondary-900"><?php echo e($beneficiario['nombre']); ?></span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <!--[if BLOCK]><![endif]--><?php if($beneficiario['modo_edicion'] ?? false): ?>
                                        <input wire:model="beneficiarios.<?php echo e($index); ?>.apellido"
                                               type="text"
                                               class="block w-full px-2 py-1 border border-secondary-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                               placeholder="Apellido">
                                    <?php else: ?>
                                        <span class="text-sm text-secondary-500"><?php echo e($beneficiario['apellido']); ?></span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <!--[if BLOCK]><![endif]--><?php if($beneficiario['modo_edicion'] ?? false): ?>
                                        <input wire:model="beneficiarios.<?php echo e($index); ?>.dni"
                                               type="text"
                                               class="block w-full px-2 py-1 border border-secondary-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                               placeholder="DNI">
                                    <?php else: ?>
                                        <span class="text-sm text-secondary-500"><?php echo e($beneficiario['dni']); ?></span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <!--[if BLOCK]><![endif]--><?php if($beneficiario['modo_edicion'] ?? false): ?>
                                        <select wire:model="beneficiarios.<?php echo e($index); ?>.id_parentesco"
                                                class="block w-full px-2 py-1 border border-secondary-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                            <option value="">Seleccionar</option>
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $parentescos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parentesco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($parentesco->id_parentesco); ?>"><?php echo e($parentesco->nombre_parentesco); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                        </select>
                                    <?php else: ?>
                                        <span class="text-sm text-secondary-500"><?php echo e($beneficiario['parentesco']); ?></span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <!--[if BLOCK]><![endif]--><?php if($beneficiario['modo_edicion'] ?? false): ?>
                                        <div class="flex items-center">
                                            <input wire:model="beneficiarios.<?php echo e($index); ?>.porcentaje"
                                                   type="number"
                                                   step="1"
                                                   min="0"
                                                   max="100"
                                    ...
                                    <?php else: ?>
                                        <span class="text-sm text-secondary-500"><?php echo e($beneficiario['porcentaje']); ?>%</span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </td>

                                <!-- Estado -->
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <!--[if BLOCK]><![endif]--><?php if(isset($beneficiario['marcado_para_eliminar']) && $beneficiario['marcado_para_eliminar']): ?>
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                            Pendiente eliminación
                                        </span>
                                    <?php elseif($beneficiario['activo']): ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <!--[if BLOCK]><![endif]--><?php if($beneficiario['modo_edicion'] ?? false): ?>
                                            <button type="button" wire:click="guardarEdicionBeneficiario(<?php echo e($index); ?>)"
                                            ...
                                            <button type="button" wire:click="cancelarEdicionBeneficiario(<?php echo e($index); ?>)"
                                        ...
                                        <?php else: ?>
                                            <button type="button" wire:click="editarBeneficiario(<?php echo e($index); ?>)"
                                            ...
                                            <button type="button" wire:click="eliminarBeneficiario(<?php echo e($index); ?>)"
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/ubuntu/Documents/FondoSolidarioEntrega/FondoSolidarioEntrega/resources/views/livewire/empleados/form.blade.php ENDPATH**/ ?>