<div>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8">
        ...
        <div class="flex items-center space-x-3">
            ...
            <a href="<?php echo e(route('beneficiarios_svo.create')); ?>" class="inline-flex items-center px-4 py-2 bg-primary-600 border border-transparent rounded-lg font-medium text-sm text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
        ...
        <details class="group" open>
            ...
            <div class="px-6 pb-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(Auth::user()->rol !== 'Usuario General'): ?>
                    <?php if(Auth::user()->rol !== 'usuario_general'): ?>
                     <div class="space-y-1">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-secondary-200">
                    ...
                    <tr>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-secondary-500 uppercase tracking-wider">
                            <button wire:click="sortBy('empleado.nombre')" class="group inline-flex items-center hover:text-secondary-700">
                                Empleado
                                <!--[if BLOCK]><![endif]--><?php if($sortField === 'empleado.nombre'): ?>
                                    ...
                                    <?php else: ?> <svg class="ml-2 w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-secondary-500 uppercase tracking-wider">
                            <button wire:click="sortBy('escuela.nombre')" class="group inline-flex items-center hover:text-secondary-700">
                                Escuela
                                <!--[if BLOCK]><![endif]--><?php if($sortField === 'escuela.nombre'): ?>
                                    <!--[if BLOCK]><![endif]--><?php if($sortDirection === 'asc'): ?> <svg class="ml-2 w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"></path></svg>
                                    <?php else: ?> <svg class="ml-2 w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <?php else: ?> <svg class="ml-2 w-4 h-4 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                         <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-secondary-500 uppercase tracking-wider">
                             <button wire:click="sortBy('apellido')" class="group inline-flex items-center hover:text-secondary-700">
                                 Beneficiario
                                <!--[if BLOCK]><![endif]--><?php if($sortField === 'apellido'): ?>
                                    <!--[if BLOCK]><![endif]--><?php if($sortDirection === 'asc'): ?> <svg class="ml-2 w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"></path></svg>
                                    <?php else: ?> <svg class="ml-2 w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <?php else: ?> <svg class="ml-2 w-4 h-4 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                         ...
                         <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-secondary-500 uppercase tracking-wider">
                             <button wire:click="sortBy('id_parentesco')" class="group inline-flex items-center hover:text-secondary-700">
                                Parentesco
                                <!--[if BLOCK]><![endif]--><?php if($sortField === 'id_parentesco'): ?>
                                    <!--[if BLOCK]><![endif]--><?php if($sortDirection === 'asc'): ?> <svg class="ml-2 w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"></path></svg>
                                    <?php else: ?> <svg class="ml-2 w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <?php else: ?> <svg class="ml-2 w-4 h-4 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <tbody class="bg-white divide-y divide-secondary-200">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $beneficiarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $beneficiario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-secondary-50 transition-colors duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-secondary-900"><?php echo e($beneficiario->empleado->apellido ?? 'N/A'); ?>, <?php echo e($beneficiario->empleado->nombre ?? 'N/A'); ?></div>
                            <div class="text-xs text-secondary-500">DNI: <?php echo e($beneficiario->empleado->dni ?? 'N/A'); ?></div>
                        </td>
                        <!--[if BLOCK]><![endif]--><?php if(Auth::user()->rol !== 'Usuario General'): ?>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-secondary-500"><?php echo e($beneficiario->escuela->nombre ?? 'N/A'); ?></div>
                        </td>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                         <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-secondary-900"><?php echo e($beneficiario->apellido); ?>, <?php echo e($beneficiario->nombre); ?></div>
                            <div class="text-xs text-secondary-500">DNI: <?php echo e($beneficiario->dni); ?></div>
                        </td>
                         <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-secondary-900"><?php echo e($beneficiario->parentesco->nombre_parentesco ?? 'N/A'); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="text-sm font-medium text-secondary-900"><?php echo e($beneficiario->porcentaje); ?>%</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <button wire:click="cambiarEstado(<?php echo e($beneficiario->id_beneficiario); ?>)"
                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                <?php echo e($beneficiario->activo ? 'bg-success-100 text-success-800' : 'bg-danger-100 text-danger-800'); ?>

                                transition-colors duration-200 hover:bg-opacity-80">
                                <svg class="w-1.5 h-1.5 mr-1.5" fill="currentColor" viewBox="0 0 8 8">
                                    <circle cx="4" cy="4" r="3"/>
                                </svg>
                                <?php echo e($beneficiario->activo ? 'Activo' : 'Inactivo'); ?>

                            </button>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center space-x-2">
                                <a href="<?php echo e(route('beneficiarios_svo.show', $beneficiario->id_beneficiario)); ?>" class="p-2 text-secondary-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors duration-200" title="Ver detalles">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                </a>
                                <a href="<?php echo e(route('beneficiarios_svo.edit', $beneficiario->id_beneficiario)); ?>" class="p-2 text-secondary-400 hover:text-warning-600 hover:bg-warning-50 rounded-lg transition-colors duration-200" title="Editar">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                </a>
                                <button wire:click="eliminar(<?php echo e($beneficiario->id_beneficiario); ?>)" wire:confirm="¿Está seguro que desea eliminar este beneficiario?" class="p-2 text-secondary-400 hover:text-danger-600 hover:bg-danger-50 rounded-lg transition-colors duration-200" title="Eliminar">
                    ...
                    <tr>
                        <td colspan="<?php echo e(Auth::user()->rol !== 'Usuario General' ? '7' : '6'); ?>" class="px-6 py-12 text-center">
        ...
        <div class="px-6 py-4 bg-secondary-50 border-t border-secondary-200">
            <div class="flex flex-col sm:flex-row items-center justify-between">
                <div class="text-sm text-secondary-700 mb-4 sm:mb-0">
                    <!--[if BLOCK]><![endif]--><?php if($beneficiarios->total() > 0): ?>
                        Mostrando <span class="font-medium text-secondary-900"><?php echo e($beneficiarios->firstItem()); ?></span> a <span class="font-medium text-secondary-900"><?php echo e($beneficiarios->lastItem()); ?></span> de <span class="font-medium text-secondary-900"><?php echo e($beneficiarios->total()); ?></span> resultados
                    <?php else: ?>
                        No hay resultados para mostrar
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
                <!--[if BLOCK]><![endif]--><?php if($beneficiarios->hasPages()): ?>
                    <?php echo e($beneficiarios->links('pagination.custom-tailwind')); ?>
...
<script>
    function exportarBeneficiarios(formato) {
        ...
        const filtroDni = window.Livewire.find('<?php echo e($_instance->getId()); ?>').get('filtro_dni');
        ...
        switch(formato) {
            case 'csv':
                url = '<?php echo e(route("beneficiarios_svo.export.csv")); ?>';
                break;
            case 'excel':
                url = '<?php echo e(route("beneficiarios_svo.export.excel")); ?>';
                break;
            case 'pdf':
                url = '<?php echo e(route("beneficiarios_svo.export.pdf")); ?>';
                break;
        }
...
<?php $__env->stopPush(); ?><?php /**PATH /home/passion/Documents/FondoSolidarioEntrega11/Fondo Solidario Entrega/resources/views/livewire/beneficiarios_svo/index.blade.php ENDPATH**/ ?>