                ...
                <tbody class="bg-white divide-y divide-secondary-200">
                    ...
                    <tr class="hover:bg-secondary-50 transition-colors duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                         ...
                         <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-secondary-900"><?php echo e($reintegro['id_accidente']); ?> (<?php echo e($reintegro['nombre_alumno']); ?>)</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            ...
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <?php if($estado == 'Solicitud de Información'): ?>
                                <div class="relative flex items-center group">
                                    ...
                                    <div class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-max max-w-md bg-secondary-800 text-white text-xs rounded-lg p-3 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-normal text-center">
                                        <?php echo e($reintegro['solicitud_informacion']); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <a href="<?php echo e(route('reintegros.edit', $reintegro['id_reintegro'])); ?>" class="p-2 text-secondary-400 hover:text-warning-600 hover:bg-warning-50 rounded-lg transition-colors duration-200" title="Editar">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rican\OneDrive\Documentos\workana\Fondo Solidario\resources\views\livewire\reintegros\index.blade.php ENDPATH**/ ?>