...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="space-y-1">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['id_prestador'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="space-y-1">
                            ...
                            >
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['fecha_derivacion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="space-y-1">
                            ...
                            >
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['hora_derivacion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="space-y-1">
                            ...
                            >
                             ...
                             <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['medico_deriva'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="space-y-1">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['acompanante'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="md:col-span-2 space-y-1">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['diagnostico_inicial'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <!-- Estado de Impresión -->
                 <!--[if BLOCK]><![endif]--><?php if($modo == 'show' || $modo == 'edit'): ?>
                <div class="space-y-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($fecha_impresion): ?>
