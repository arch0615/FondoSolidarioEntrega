...
<body>
    <div class="no-print my-4 text-center">
        <a href="{{ route('derivaciones.pdf', $derivacion->id_derivacion) }}" target="_blank" class="inline-block bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition-transform transform hover:scale-105">
            Descargar PDF
        </a>
