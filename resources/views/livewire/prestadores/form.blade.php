    ...
    <div class="mb-8">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('prestadores.edit', $prestador_id) }}" class="inline-flex items-center px-4 py-2 border border-secondary-300 rounded-lg text-sm font-medium text-secondary-700 bg-white hover:bg-secondary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
            ...
            <div class="border-b border-secondary-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input wire:model="nombre" type="text" id="nombre" class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 {{ $modo == 'show' ? 'bg-secondary-50' : 'bg-white' }}" placeholder="Ej: Hospital San Roque" {{ $modo == 'show' ? 'readonly' : '' }}>
                    ...
                    <div class="space-y-1">
                        ...
                        <select wire:model="id_tipo_prestador" id="id_tipo_prestador" class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 {{ $modo == 'show' ? 'bg-secondary-50' : 'bg-white' }}" {{ $modo == 'show' ? 'disabled' : '' }}>
                            <option value="">Seleccione un tipo</option>
                            @foreach($tiposPrestador as $tipo)
                                <option value="{{ $tipo->id_tipo_prestador }}">{{ $tipo->descripcion }}</option>
                            @endforeach
                        </select>
                        @error('id_tipo_prestador') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="flex items-center">
                            <div class="flex items-center h-5">
                                <input wire:model="es_sistema_emergencias" type="checkbox" id="es_sistema_emergencias" class="w-4 h-4 text-primary-600 bg-white border-secondary-300 rounded focus:ring-primary-500 focus:ring-2" {{ $modo == 'show' ? 'disabled' : '' }}>
                            </div>
                            <div class="ml-3">
                        ...
                        @error('es_sistema_emergencias') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
            ...
            <div class="border-b border-secondary-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input wire:model="direccion" type="text" id="direccion" class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 {{ $modo == 'show' ? 'bg-secondary-50' : 'bg-white' }}" placeholder="Ej: Av. Vélez Sarsfield 562, Córdoba" {{ $modo == 'show' ? 'readonly' : '' }}>
                    ...
                    <div class="space-y-1">
                        ...
                        <input wire:model="telefono" type="tel" id="telefono" class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 {{ $modo == 'show' ? 'bg-secondary-50' : 'bg-white' }}" placeholder="Ej: (351) 421-7000" {{ $modo == 'show' ? 'readonly' : '' }}>
                    ...
                    <div class="space-y-1">
                        ...
                        <input wire:model="email" type="email" id="email" class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 {{ $modo == 'show' ? 'bg-secondary-50' : 'bg-white' }}" placeholder="Ej: info@prestador.com.ar" {{ $modo == 'show' ? 'readonly' : '' }}>
            ...
            <div class="border-b border-secondary-200 pb-6">
                ...
                <div class="space-y-4">
                    <div class="space-y-1">
                        ...
                        <textarea wire:model="especialidades" id="especialidades" rows="4" class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 {{ $modo == 'show' ? 'bg-secondary-50' : 'bg-white' }}" placeholder="Ej: Cardiología, Neurología, Pediatría, Traumatología" {{ $modo == 'show' ? 'readonly' : '' }}></textarea>
