...
<div class="mx-auto px-4">
    ...
    <div class="mb-8">
        <nav class="flex items-center text-sm text-secondary-500 mb-4">
            {{-- TODO: Definir la ruta correcta para el listado de salidas educativas --}}
            <a href="{{ route('salidas_educativas.index') }}" class="hover:text-secondary-700">Salidas Educativas</a>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('salidas_educativas.edit', $salida_id ?? 1) }}" class="inline-flex items-center px-4 py-2 border border-secondary-300 rounded-lg text-sm font-medium text-secondary-700 bg-white hover:bg-secondary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
    ...
    <div class="bg-white rounded-xl border border-secondary-200">
        ...
        <form action="{{ $modo == 'create' ? route('salidas_educativas.index') : route('salidas_educativas.index') }}" method="POST" class="space-y-6 p-6">
            @csrf
            @if($modo == 'edit')
                @method('PUT')
            @endif
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            ...
                            {{-- Opciones de escuelas --}}
                             <option value="1" {{ ($salida_id ?? '' == 1) ? 'selected' : '' }}>Colegio San Martín</option>
                             <option value="2" {{ ($salida_id ?? '' == 2) ? 'selected' : '' }}>Instituto Belgrano</option>
                        </select>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="{{ $salida_id ?? '' == 1 ? '2024-10-15' : ($salida_id ?? '' == 2 ? '2024-11-20' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            id="hora_salida"
                            class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm {{ $modo == 'show' ? 'bg-secondary-50' : 'bg-white' }}"
                            value="{{ $salida_id ?? '' == 1 ? '08:00' : ($salida_id ?? '' == 2 ? '09:30' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            id="hora_regreso"
                            class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm {{ $modo == 'show' ? 'bg-secondary-50' : 'bg-white' }}"
                            value="{{ $salida_id ?? '' == 1 ? '17:00' : ($salida_id ?? '' == 2 ? '16:00' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input
                            ...
                            value="{{ $salida_id ?? '' == 1 ? 'Museo de Ciencias Naturales' : ($salida_id ?? '' == 2 ? 'Fábrica de Alfajores' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <textarea
                            ...
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >{{ $salida_id ?? '' == 1 ? 'Visita guiada para complementar contenidos de biología.' : ($salida_id ?? '' == 2 ? 'Conocer el proceso de producción industrial.' : '') }}</textarea>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="{{ $salida_id ?? '' == 1 ? '5to Grado' : ($salida_id ?? '' == 2 ? '3er Año' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 {{ $modo == 'show' ? 'bg-secondary-50' : 'bg-white' }}"
                            placeholder="Ej: 30"
                            value="{{ $salida_id ?? '' == 1 ? '35' : ($salida_id ?? '' == 2 ? '28' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input
                            ...
                            value="{{ $salida_id ?? '' == 1 ? 'Prof. Ana Gómez, Prof. Carlos Ruiz' : ($salida_id ?? '' == 2 ? 'Prof. Laura Fernández' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input
                            ...
                            value="{{ $salida_id ?? '' == 1 ? 'Colectivo escolar' : ($salida_id ?? '' == 2 ? 'Transporte público' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
            ...
            {{-- TODO: Sección para adjuntar autorizaciones parentales --}}
            <div class="border-b border-secondary-200 pb-6">
            ...
            <div class="flex items-center justify-between pt-6 border-t border-secondary-200">
                {{-- TODO: Definir la ruta correcta para el listado de salidas educativas --}}
                <a href="{{ route('salidas_educativas.index') }}" class="inline-flex items-center px-4 py-2 border border-secondary-300 rounded-lg text-sm font-medium text-secondary-700 bg-white hover:bg-secondary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
