...
<div class="mx-auto px-4">
    ...
    <div class="mb-8">
        <nav class="flex items-center text-sm text-secondary-500 mb-4">
            {{-- TODO: Definir la ruta correcta para el listado de pasantías --}}
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('pasantias.edit', $pasantia_id ?? 1) }}" class="inline-flex items-center px-4 py-2 border border-secondary-300 rounded-lg text-sm font-medium text-secondary-700 bg-white hover:bg-secondary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
    ...
    <div class="bg-white rounded-xl border border-secondary-200">
        ...
        <form action="{{ $modo == 'create' ? route('pasantias.index') : route('pasantias.index') }}" method="POST" class="space-y-6 p-6">
            @csrf
            @if($modo == 'edit')
                @method('PUT')
            @endif
            ...
            <div class="border-b border-secondary-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            <option value="">Seleccione una escuela</option>
                             <option value="1" {{ ($pasantia_id ?? '' == 1) ? 'selected' : '' }}>Colegio San Martín</option>
                             <option value="2" {{ ($pasantia_id ?? '' == 2) ? 'selected' : '' }}>Instituto Belgrano</option>
                        </select>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        {{-- TODO: Implementar selección de alumno dinámica (filtrada por escuela) --}}
                        <select
                            name="id_alumno"
                            id="id_alumno"
                            class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 {{ $modo == 'show' ? 'bg-secondary-50' : 'bg-white' }}"
                        ...
                        >
                            ...
                            <option value="101" {{ ($pasantia_id ?? '' == 1) ? 'selected' : '' }}>Pedro Gómez (DNI: 30123456)</option>
                            <option value="102" {{ ($pasantia_id ?? '' == 2) ? 'selected' : '' }}>Ana Torres (DNI: 31987654)</option>
                        </select>
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input
                            ...
                            value="{{ $pasantia_id ?? '' == 1 ? 'Tech Solutions S.A.' : ($pasantia_id ?? '' == 2 ? 'Creative Marketing' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <input
                            ...
                            value="{{ $pasantia_id ?? '' == 1 ? 'Av. Principal 456, Córdoba' : ($pasantia_id ?? '' == 2 ? 'Calle Secundaria 789, Córdoba' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="{{ $pasantia_id ?? '' == 1 ? 'Ing. Ricardo López' : ($pasantia_id ?? '' == 2 ? 'Lic. Laura Méndez' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="{{ $pasantia_id ?? '' == 1 ? '2025-01-10' : ($pasantia_id ?? '' == 2 ? '2025-02-01' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            id="fecha_fin"
                            class="block w-full px-3 py-2 border border-secondary-300 rounded-lg text-sm {{ $modo == 'show' ? 'bg-secondary-50' : 'bg-white' }}"
                            value="{{ $pasantia_id ?? '' == 1 ? '2025-03-10' : ($pasantia_id ?? '' == 2 ? '2025-04-01' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            ...
                            value="{{ $pasantia_id ?? '' == 1 ? 'Lunes a Viernes de 9:00 a 13:00' : ($pasantia_id ?? '' == 2 ? 'Martes y Jueves de 14:00 a 18:00' : '') }}"
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-1">
                        ...
                        <textarea
                            ...
                            {{ $modo == 'show' ? 'readonly' : '' }}
                            required
                        >{{ $pasantia_id ?? '' == 1 ? 'Desarrollo de software, testing y documentación.' : ($pasantia_id ?? '' == 2 ? 'Gestión de redes sociales, creación de contenido.' : '') }}</textarea>
                    </div>
                </div>
            </div>

            {{-- TODO: Sección para adjuntar documentación de la pasantía --}}
            <div class="border-b border-secondary-200 pb-6">
