<div class="mx-auto px-4">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8">
        ...
        <div class="flex items-center space-x-3">
            ...
            {{-- TODO: Definir la ruta correcta para crear un nuevo usuario --}}
            <a href="{{ route('usuarios.create') }}" class="inline-flex items-center px-4 py-2 bg-primary-600 border border-transparent rounded-lg font-medium text-sm text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
