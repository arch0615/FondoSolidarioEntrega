...
<div class="mx-auto px-4">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8">
        ...
        <div class="flex items-center space-x-3">
            ...
            <!-- Botón Nueva Escuela -->
            <a href="{{ route('escuelas.create') }}" class="inline-flex items-center px-4 py-2 bg-primary-600 border border-transparent rounded-lg font-medium text-sm text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
            ...
            <div class="p-6 flex-grow">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        ...
                        <p class="text-xs text-secondary-500">Código: {{ $escuela['codigo'] }}</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        ...
                        <div x-data="{ open: false }" @click.away="open = false" class="relative">
                            ...
                            <div x-show="open"
                                 ...
                                 style="display: none;">
                                <a href="{{ route('escuelas.show', $escuela['id']) }}" class="flex items-center gap-2 px-4 py-2 text-sm text-secondary-700 hover:bg-secondary-100 hover:text-secondary-900 w-full text-left">
                                    <i class="fas fa-eye fa-fw text-secondary-400"></i>
                                    Consultar
                                </a>
                                <a href="{{ route('escuelas.edit', $escuela['id']) }}" class="flex items-center gap-2 px-4 py-2 text-sm text-secondary-700 hover:bg-secondary-100 hover:text-secondary-900 w-full text-left">
                ...
                <div class="mb-4 text-sm text-secondary-700 space-y-1">
                    <p><i class="fas fa-phone-alt text-secondary-400 mr-2 fa-fw"></i>{{ $escuela['telefono'] }}</p>
                    <p><i class="fas fa-envelope text-secondary-400 mr-2 fa-fw"></i>{{ $escuela['email'] }}</p>
                    <p><i class="fas fa-map-marker-alt text-secondary-400 mr-2 fa-fw"></i>{{ $escuela['direccion'] }}</p>
                </div>
                ...
                <div class="border-t border-secondary-200 pt-4 mb-4">
                    ...
                    <div class="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
                        <p class="text-secondary-700">Alumnos: <span class="font-semibold text-secondary-900">{{ $escuela['alumnos'] }}</span></p>
                        <p class="text-secondary-700">Empleados: <span class="font-semibold text-secondary-900">{{ $escuela['empleados'] }}</span></p>
                        <p class="text-secondary-700">Salidas Ed.: <span class="font-semibold text-secondary-900">{{ $escuela['salidas'] }}</span></p>
                        <p class="text-secondary-700">Pasantías: <span class="font-semibold text-secondary-900">{{ $escuela['pasantias'] }}</span></p>
                        <p class="text-secondary-700">Benef. SVO: <span class="font-semibold text-secondary-900">{{ $escuela['svo'] }}</span></p>
                        <p class="text-secondary-700">Accidentes: <span class="font-semibold text-secondary-900">{{ $escuela['accidentes'] }}</span></p>
                        <p class="text-secondary-700">Derivaciones: <span class="font-semibold text-secondary-900">{{ $escuela['derivaciones'] }}</span></p>
                        <p class="text-secondary-700">Reintegros: <span class="font-semibold text-secondary-900">{{ $escuela['reintegros'] }}</span></p>
                    </div>
                </div>
            </div>
            {{-- El div de acciones se movió al encabezado de la card --}}
        </div>
        @endforeach
    </div>
    <!-- Paginación -->
