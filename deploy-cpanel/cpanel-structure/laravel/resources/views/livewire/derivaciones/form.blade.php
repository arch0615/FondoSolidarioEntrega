        ...
        <div class="mb-8">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-3">
                    <a href="{{ route('derivaciones.edit', $derivacion_id) }}" class="inline-flex items-center px-4 py-2 border border-secondary-300 rounded-lg text-sm font-medium text-secondary-700 bg-white hover:bg-secondary-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
                ...
                <div class="border-b border-secondary-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1">
                            ...
                            @error('id_prestador') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <input
                                ...
                                {{ $modo == 'show' ? 'readonly' : '' }}
                            >
                            @error('fecha_derivacion') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <input
                                ...
                                {{ $modo == 'show' ? 'readonly' : '' }}
                            >
                            @error('hora_derivacion') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            >
                             ...
                             @error('medico_deriva') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            @error('acompanante') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            @if($fecha_impresion)
                            <p class="text-xs text-secondary-500">Fecha de impresión: {{ \Carbon\Carbon::parse($fecha_impresion)->format('d/m/Y h:i A') }}</p>
                            @endif
                        </div>
                    </div>
                </div>
