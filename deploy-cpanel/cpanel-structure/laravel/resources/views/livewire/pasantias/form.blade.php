    ...
    <div class="mx-auto px-4">
        ...
        <div class="mb-8">
            <nav class="flex items-center text-sm text-secondary-500 mb-4">
                <a href="{{ route('pasantias.index') }}" class="hover:text-secondary-700">Pasantías / Prácticas Profesionales</a>
                ...
                <span class="text-secondary-900">{{ $modo == 'create' ? 'Nueva Pasantía / Práctica Profesional' : ($modo == 'edit' ? 'Editar Pasantía / Práctica Profesional' : 'Detalles de Pasantía / Práctica Profesional') }}</span>
            </nav>
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-semibold text-secondary-900">
                        {{ $modo == 'create' ? 'Nueva Pasantía / Práctica Profesional' : ($modo == 'edit' ? 'Editar Pasantía / Práctica Profesional' : 'Detalles de Pasantía / Práctica Profesional') }}
                    </h1>
                    <p class="mt-1 text-sm text-secondary-600">
                        {{ $modo == 'create' ? 'Complete los datos para registrar una nueva pasantía o práctica profesional' : ($modo == 'edit' ? 'Modifique los datos de la pasantía o práctica profesional' : 'Información detallada de la pasantía o práctica profesional') }}
                    </p>
                </div>
                @if($modo == 'show')
            ...
            <form wire:submit.prevent="guardar" class="space-y-6 p-6">
                ...
                <div class="flex items-center justify-between pt-6 border-t border-secondary-200">
                    ...
                    <button type="submit" class="inline-flex items-center px-6 py-2 bg-primary-600 border border-transparent rounded-lg font-medium text-sm text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
                        ...
                        {{ $modo == 'create' ? 'Crear Pasantía / Práctica Profesional' : 'Actualizar Pasantía / Práctica Profesional' }}
                    </button>
                    @endif
                </div>
            </form>
