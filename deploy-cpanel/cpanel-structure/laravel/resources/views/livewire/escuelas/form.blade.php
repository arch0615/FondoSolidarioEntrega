    ...
    <div class="bg-white rounded-xl border border-secondary-200">
        <form wire:submit.prevent="guardar" class="space-y-6 p-6">
            ...
            <div class="flex items-center justify-between pt-6">
                <a href="{{ route('escuelas.index') }}" class="inline-flex items-center px-4 py-2 border border-secondary-300 rounded-lg text-sm font-medium text-secondary-700 bg-white hover:bg-secondary-50">
                    Volver al Listado
                </a>
                @if($modo != 'show')
