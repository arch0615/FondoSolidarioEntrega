...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('salidas-educativas')->name('salidas-educativas.')->middleware('auth')->group(function () {
        ...
        Route::get('/create', \App\Livewire\SalidasEducativas\Form::class)->name('create');
        Route::get('/{id}/edit', \App\Livewire\SalidasEducativas\Form::class)->name('edit');
        Route::get('/{id}', \App\Livewire\SalidasEducativas\Form::class)->name('show');
