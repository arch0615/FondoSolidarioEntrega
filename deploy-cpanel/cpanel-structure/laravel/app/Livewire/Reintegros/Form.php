...
class Form extends Component
{
    ...
    public function mount($modo = 'create', $reintegro_id = null, $id_accidente = null)
    {
        $this->modo = $modo;
        ...
        // Si viene un id_accidente desde la URL, pre-seleccionarlo
        if ($id_accidente && $modo == 'create') {
            $this->id_accidente = $id_accidente;
            $this->updatedIdAccidente($id_accidente);
        }
